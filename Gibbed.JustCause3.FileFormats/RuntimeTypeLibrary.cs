...
{
    public class RuntimeTypeLibrary
    {
        private readonly Dictionary<uint, AdfFile.TypeDefinition> _TypeDefinitions;

        public RuntimeTypeLibrary()
        {
            this._TypeDefinitions = new Dictionary<uint, AdfFile.TypeDefinition>();
        }
        ...
        public AdfFile.TypeDefinition GetTypeDefinition(uint nameHash)
        {
        ...
        public void AddTypeDefinitions(AdfFile adf)
        {
